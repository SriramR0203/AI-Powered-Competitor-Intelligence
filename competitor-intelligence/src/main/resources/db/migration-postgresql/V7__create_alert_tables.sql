CREATE TABLE IF NOT EXISTS alert_rules (
    ...
    min_importance_score DOUBLE PRECISION,
...
CREATE INDEX IF NOT EXISTS idx_alert_rules_competitor ON alert_rules (competitor_id);
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_rule ON alert_subscriptions (alert_rule_id);
...
CREATE INDEX IF NOT EXISTS idx_notifications_event   ON alert_notifications (intelligence_event_id);
CREATE INDEX IF NOT EXISTS idx_notifications_status  ON alert_notifications (status);
CREATE INDEX IF NOT EXISTS idx_notifications_created ON alert_notifications (created_at);
