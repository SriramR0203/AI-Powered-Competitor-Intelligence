...
CREATE INDEX IF NOT EXISTS idx_sources_competitor  ON intelligence_sources (competitor_id);
CREATE INDEX IF NOT EXISTS idx_sources_type        ON intelligence_sources (source_type);
CREATE INDEX IF NOT EXISTS idx_sources_active      ON intelligence_sources (is_active);
CREATE INDEX IF NOT EXISTS idx_sources_next_scrape ON intelligence_sources (next_scrape_at);
