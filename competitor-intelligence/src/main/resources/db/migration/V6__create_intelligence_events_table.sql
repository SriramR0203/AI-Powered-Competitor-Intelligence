...
CREATE INDEX idx_events_competitor   ON intelligence_events (competitor_id);
CREATE INDEX idx_events_source       ON intelligence_events (source_id);
CREATE INDEX idx_events_category     ON intelligence_events (category);
CREATE INDEX idx_events_sentiment    ON intelligence_events (sentiment);
CREATE INDEX idx_events_status       ON intelligence_events (processing_status);
CREATE INDEX idx_events_published_at ON intelligence_events (published_at);
